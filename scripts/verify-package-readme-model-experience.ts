...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-session-history-gate': { kind: 'indirect', reason: 'Browser-side settings row; the Host session-history gate owns every model-facing effect.' },
  ...
  'packages/client/ui-automation': { kind: 'none', reason: 'Browser-side Host Automation manager; dsh-tool-automation owns the model-facing behavior.' },
  ...
  'packages/client/ui-settings-system-prompts': { kind: 'none', reason: 'Browser-side settings surface; the Host user-system-prompts plugin owns the model-visible effect.' },
  ...
  'packages/client/ui-git-branch': { kind: 'none', reason: 'Browser-side Git branch chip; the host worktree overlay owns every model-facing cwd effect.' },
  ...
  'packages/client/ui-update': { kind: 'none', reason: 'Host/browser product-update surface; registers nothing model-facing.' },
  ...
  'packages/client/ui-settings-plugin-marketplace': { kind: 'none', reason: 'Browser-side marketplace settings surface; registers nothing model-facing.' },
  ...
  'packages/host/plugin-catalog': { kind: 'none', reason: 'The Host catalog route serves a JSON listing and registers nothing model-facing.' },
  ...
  'packages/session/session-route': { kind: 'none', reason: 'The requestRoute unit folds already-logged request headers into a client-facing read model and registers nothing model-facing.' },
  ...
  'packages/skill/skill-session-control': { kind: 'indirect', reason: 'The bundled provider delegates model rendering to dsh-tool-skill.' },
