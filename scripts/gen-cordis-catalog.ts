...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  sessionControl: 'session-control.md',
  ...
  userSystemPrompts: 'system-prompt.md',
  jobs: 'jobs.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  pluginMarketplaceUi: 'client-side marketplace occupancy marker — packages/client/ui-settings-plugins/README.md owns the API',
  profile: 'not a service: launcher-provided booted-profile identity (ProfileHandle | undefined) — packages/boot/app-boot/README.md owns the boot contract',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SessionControlActivity: 'session-control.md',
  SessionControlDeliveryMode: 'session-control.md',
  SessionControlEntry: 'session-control.md',
  SessionControlSearchRequest: 'session-control.md',
  SessionControlSendReceipt: 'session-control.md',
  SessionControlSendRequest: 'session-control.md',
  SessionControlStopReceipt: 'session-control.md',
  ...
  AutomationRuleId: 'automation.md',
  AutomationRuleView: 'automation.md',
  AutomationRunRecord: 'automation.md',
  CreateAutomationRuleRequest: 'automation.md',
  UpdateAutomationRuleRequest: 'automation.md',
  AutomationRuleRecord: 'automation.md',
  ...
  RegisteredPromptSection: 'system-prompt.md',
  SystemPrompt: 'system-prompt.md',
