...
[`docs/cookbook/opening-a-pull-request.md`](../../../../docs/cookbook/opening-a-pull-request.md) is the checklist for opening, labeling, evidencing, and landing a pull request. [`CONTRIBUTING.md`](../../../../CONTRIBUTING.md) is the community entry and links that cookbook.
...
**Put the full checklist in `CONTRIBUTING.md`.** That file stays the short community entry. A procedure with Issue citation, labels, evidence, and landing steps belongs in a cookbook, with a one-line link from CONTRIBUTING.
...
Contributors have one procedure for a ready-for-review human pull request. Policy changes still land in their owning workflow, taxonomy note, or skill; the cookbook updates in the same change when those required steps change. Community readers who open `CONTRIBUTING.md` are sent to the same checklist.
