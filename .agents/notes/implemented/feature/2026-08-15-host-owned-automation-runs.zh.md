...
tool、Host RPC 和 Web 侧栏面板是同一服务的 Consumer。本记录交付服务、持久表、origin/cancel-cause 扩展、模型 tool、Host RPC 和包测试。[Web Automation 侧栏](2026-08-15-web-automation-sidebar.zh.md) 在该接口上占据 New Session 下方 `sidebar.automation` 列表的第一项。
