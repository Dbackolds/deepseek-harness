...
**Hiding the whole actions row until hover.** Copy and branch are affordances worth discovering, and row-level show/hide risks layout shift. The event clock now lives on the message row; only the passive metrics text shares this footer.
