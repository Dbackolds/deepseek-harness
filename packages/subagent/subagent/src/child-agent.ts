 ...
 * @param extra - optional child cwd override; absent inherits the parent session directory.
...
export function childSessionMeta(
  ...
  const cwd = extra.cwd ?? parentHeader.cwd
  return {
    ...cwd !== undefined ? { cwd } : {},
...
export interface ChildCreateInputs {
  ...
  /** Whether this child inherits a parent-log prefix. */
