...
export const zh = {
  ...
  'video.dropTitle': '视频拖动到此处即可添加',
  'video.dropDesc': '最多 {count} 个，每个 {size}',
  'video.pending': '待发送视频',
  'video.remove': '移除视频 {name}',
  'video.scrollLeft': '向左滚动视频',
  'video.scrollRight': '向右滚动视频',
  'video.label': '视频',
  'video.loadFailed': '视频加载失败，点击重试',
  'video.loading': '视频加载中…',
  'video.unsupportedType': '仅支持 MP4、MKV、MOV 格式的视频',
  'video.tooMany': '一条消息最多添加 {count} 个视频',
  'video.fileTooLarge': '单个视频不能超过 {size}',
  'video.totalTooLarge': '视频总大小超过 {size}，请移除部分视频',
  'video.modelUnsupported': '当前模型不支持视频，请切换支持视频的模型',
  'video.subagentUnsupported': '子智能体会话暂不支持视频',
  'video.sendFailed': '视频发送失败（{reason}），请重新添加视频后再试',
  ...
  'command.videosUnsupported': '命令不接受视频附件，请先移除视频',
  ...
  'queue.reorderFailed': '调整顺序失败，请重试。',
...
export const en = {
  ...
  'video.dropTitle': 'Drag videos here to add them',
  'video.dropDesc': 'Up to {count} videos, {size} each',
  'video.pending': 'Pending videos',
  'video.remove': 'Remove video {name}',
  'video.scrollLeft': 'Scroll videos left',
  'video.scrollRight': 'Scroll videos right',
  'video.label': 'Video',
  'video.loadFailed': 'Video failed to load; click to retry',
  'video.loading': 'Loading video…',
  'video.unsupportedType': 'Only MP4, MKV, and MOV videos are supported',
  'video.tooMany': 'A message can include up to {count} videos',
  'video.fileTooLarge': 'Each video must be smaller than {size}',
  'video.totalTooLarge': 'Videos exceed {size} in total; remove some and try again',
  'video.modelUnsupported': 'The current model does not support videos; switch to a model that does',
  'video.subagentUnsupported': 'Subagent sessions do not support videos yet',
  'video.sendFailed': 'Sending videos failed ({reason}); re-add them and try again',
  ...
  'hero.chooseBranch': 'Choose branch',
  ...
  'command.videosUnsupported': 'Commands do not accept video attachments; remove them first',
  ...
  'queue.reorderFailed': 'Reorder failed. Try again.',
