...
function UserStyleBubble({
  content, renderMessageImages, actions, pending = false, time, editing = false, draft, onDraftChange,
  onSaveEdit, onCancelEdit, referenceLabels = [], t,
}: {
...
export const UserMessageNodeView = memo(function UserMessageNodeView({
  node, renderMessageImages, rewriteAt, t,
