...
| [`ui-automation/`](ui-automation/README.md) | 在 New Session 下方列出并创建 Host Automation 规则。 |
...
| [`ui-settings-plugin-marketplace/`](ui-settings-plugin-marketplace/README.md) | 拥有随安装内置的插件市场页：发现、已安装插件，以及斜杠命令重载。 |
...
| [`ui-settings-subagents/`](ui-settings-subagents/README.md) | 拥有“子代理”设置分区：繁忙态投递偏好与用户定义库。 |
