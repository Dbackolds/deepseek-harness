...
| [`ui-automation/`](ui-automation/README.zh.md) | 在 New Session 下方列出并创建 Host Automation 规则。 |
...
| [`ui-settings-plugin-marketplace/`](ui-settings-plugin-marketplace/README.zh.md) | 拥有随安装内置的插件市场页：发现、已安装插件，以及斜杠命令重载。 |
...
| [`ui-git-branch/`](ui-git-branch/README.zh.md) | 选择会话的 Git 分支，并用 worktree 隔离。 |
| [`ui-settings-system-prompts/`](ui-settings-system-prompts/README.zh.md) | 拥有“系统提示词”设置分区：用户提示词库与按模型组装。 |
| [`ui-settings/`](ui-settings/README.zh.md) | 承载设置界面及其扩展区域。 |
| [`ui-settings-general/`](ui-settings-general/README.zh.md) | 提供常规设置分区。 |
| [`ui-settings-llm-policy/`](ui-settings-llm-policy/README.zh.md) | 编辑产品级模型请求重试预算与流空闲超时。 |
| [`ui-settings-models/`](ui-settings-models/README.zh.md) | 提供模型提供方配置与 DeepSeek 配置引导。 |
| [`ui-settings-subagents/`](ui-settings-subagents/README.zh.md) | 拥有“子代理”设置分区：繁忙态投递偏好与用户定义库。 |
