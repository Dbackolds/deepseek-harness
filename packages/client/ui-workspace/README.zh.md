...
- **没有 Session 删除与取消归档控件**：会话可以归档，但已归档会话没有查看或取消归档入口；删除 Workspace 注册记录不会删除 Session。隐藏的 Workspace 有显示入口；已归档 Session 仍没有取消归档入口。
