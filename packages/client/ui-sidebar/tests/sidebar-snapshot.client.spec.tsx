 ...
 * holes (sidebar.automation list / sidebar.workspaces / sidebar.settings) have no
 * registrant here, so the snapshots pin the shell chrome itself.
 */
...
describe('sidebar shell snapshots', () => {
  ...
  it('renders the collapsed rail after the crossfade settles, in place', async () => {
    ...
    // The wide content (wordmark shortcut) unmounts at the 300ms slide settle;
