...
export const en = {
  ...
  modelImageInput: 'Supports images',
  modelImageInputHint: 'Declares that this model accepts image input. The provider still rejects a request its endpoint cannot serve.',
  modelSystemPrompt: 'System prompt',
  modelSystemPromptPlaceholder: 'Leave empty to keep the default system prompt. Filling this replaces the entire system prompt for this model.',
  addModel: 'Add model',
  ...
  modelApi: 'API protocol',
  modelApiInherit: 'Use provider default',
  modelKeyInput: 'API key',
  modelKeyPlaceholder: 'Leave empty to use the provider key',
  modelKeyStored: 'Configured — enter a new value to replace',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelAdvanced: '容量',
  modelImageInput: '支持图片',
  modelImageInputHint: '声明该模型接受图片输入。若端点实际并不接受，提供方仍会拒绝该请求。',
  modelSystemPrompt: '系统提示词',
  modelSystemPromptPlaceholder: '留空使用默认系统提示词；填写后替换该模型的整段系统提示词。',
  addModel: '添加模型',
  removeModel: '删除模型',
  ...
  customApiUnset: '未选择',
  modelApi: 'API 协议',
  modelApiInherit: '使用提供方默认',
  modelKeyInput: 'API 密钥',
  modelKeyPlaceholder: '留空则使用提供方密钥',
  modelKeyStored: '已配置——输入新值可替换',
