...
/** Coordinates durable Host acknowledgement, with an optional process-local fallback. */
export class WelcomeNoticeStore {
   ...
   * @param persistence - process-local memory for compositions that withhold Host settings.
   */
  constructor(
