...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      'ask_user_question', 'automation_create', 'automation_delete', 'automation_list',
      'automation_set_enabled', 'automation_update', 'bash', 'bash', 'cordis_define',
      'cordis_inspect_list', 'cordis_inspect_query', 'cordis_inspect_self', 'cordis_run',
      ...
      'session_control_stop', 'session_control_unarchive', 'session_control_workspaces',
      'session_event_read', 'session_event_search', 'session_event_trace', 'session_search',
      'session_trace', 'skill', 'spawn_teammate', 'str_replace_editor', 'subagent',
