...
import type {
  ...
  VideoAttachmentRef, VideoMediaType,
...
export interface SessionListMetadata {
  ...
  readonly interrupted?: true | undefined
}
...
export interface SessionErrorDetailsMap {
  ...
  'rewrite-unavailable': { readonly sessionId: SessionId }
...
/** Rewrite one settled user prompt in this same Session. */
...
/** Receipt after one rewrite is admitted. */
export interface SessionRewriteValue {
  readonly accepted: true
}

/** Move this Session's effective home to an existing directory. */
export interface SessionRehomeRequest {
  readonly sessionId: SessionId
  readonly path: string
}

/** Receipt after a successful rehome. */
export interface SessionRehomeValue {
  readonly workspaceId: WorkspaceId
  readonly path: string
  readonly cwd: string
}
...
export interface SessionAttachmentValue {
  readonly attachment: ImageAttachmentRef | VideoAttachmentRef
  readonly data: string
}
