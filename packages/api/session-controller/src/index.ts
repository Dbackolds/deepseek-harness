...
export class SessionController extends TypertRemoteService {
   ...
   */
  @Remote('rehome')
  rehome(request: SessionRehomeRequest): Promise<SessionRehomeValue> {
    return this.commands.rehome(request)
  }
   ...
   */
  @Remote('rewrite')
  rewrite(request: SessionRewriteRequest): Promise<SessionRewriteValue> {
    return this.commands.rewrite(request)
  }
