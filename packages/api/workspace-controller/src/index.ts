...
import type {
  ...
  WorkspaceHiddenValue,
  WorkspaceHideRequest,
...
export class WorkspaceController extends TypertRemoteService {
  ...
  /**
   * Restore one known Session onto Workspace grouping surfaces.
  ...
  /**
   * Hide one registered Workspace from grouping surfaces without ungrouping Sessions.
   * @param request - Workspace identity to hide.
   * @returns the complete resulting hidden set.
   */
  @Remote('hide')
  hide(request: WorkspaceHideRequest): Promise<WorkspaceHiddenValue> {
    return this.commands.hide(request.workspaceId)
  }

  /**
   * Show one registered Workspace in grouping surfaces.
   * @param request - Workspace identity to show.
   * @returns the complete resulting hidden set.
   */
  @Remote('show')
  show(request: WorkspaceHideRequest): Promise<WorkspaceHiddenValue> {
