...
export interface WorkspaceSnapshot {
  ...
  /** Complete registry-global hidden Workspace set in Host hide order. */
...
export interface WorkspaceFollowSink {
  ...
  /** Replace the complete hidden Workspace set. */
  replaceHidden(workspaceIds: readonly WorkspaceId[]): void
}
...
export class ClientWorkspaceModel implements WorkspaceFollowSink {
  ...
  replaceHidden(hiddenWorkspaceIds: readonly WorkspaceId[]): void {
    this.installHidden(hiddenWorkspaceIds)
  }
