  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Unarchive a session from the registry-global set. Grouping surfaces restore the prior accounting slot. Does not open the session or change the current selection.',
