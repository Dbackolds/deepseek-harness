...
import {
  ...
  sessionRewriteRequestSchema,
  sessionHistoryRequestSchema,
  sessionListRequestSchema,
  sessionModelsRequestSchema,
  sessionPromptRequestSchema,
  sessionRenameRequestSchema,
  sessionRehomeRequestSchema,
...
import {
  ...
  automationDeleteRunRequestSchema,
...
import { systemPromptListRequestSchema } from '../api/system-prompt.schema.ts'
import {
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'session.rehome': { schema: sessionRehomeRequestSchema, invoke: (api, r) => api.sessions.rehome(r) },
  'session.fork': { schema: sessionForkRequestSchema, invoke: (api, r) => api.sessions.fork(r) },
  'session.rewrite': { schema: sessionRewriteRequestSchema, invoke: (api, r) => api.sessions.rewrite(r) },
  ...
  'automation.deleteRun': { schema: automationDeleteRunRequestSchema, invoke: (api, r) => api.automation.deleteRun(r) },
  ...
  'systemPrompt.list': { schema: systemPromptListRequestSchema, invoke: (api, r) => api.systemPrompt.list(r) },
}
