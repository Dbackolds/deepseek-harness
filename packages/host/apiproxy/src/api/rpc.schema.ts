...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('workspace-invalid-path'), message: z.string(), details: z.object({ path: z.string(), workspaceId: z.string().optional() }) }),
  z.object({ code: z.literal('workspace-name-conflict'), message: z.string(), details: z.object({ name: z.string() }) }),
  z.object({ code: z.literal('workspace-folder-conflict'), message: z.string(), details: z.object({ path: z.string(), workspaceId: z.string() }) }),
  ...
  z.object({ code: z.literal('git-not-a-repository'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('git-branch-invalid'), message: z.string(), details: z.object({ branch: z.string() }) }),
  z.object({ code: z.literal('git-branch-exists'), message: z.string(), details: z.object({ branch: z.string() }) }),
  z.object({ code: z.literal('git-failed'), message: z.string(), details: z.object({ reason: z.string() }) }),
  ...
  z.object({ code: z.literal('session-rehome-no-repo'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('fork-unavailable'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
  z.object({ code: z.literal('rewrite-unavailable'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
  ...
  z.object({ code: z.literal('automation-rejected'), message: z.string(), details: z.object({ automationCode: z.string() }) }),
