...
export interface RpcMethodMap {
  ...
  'session.rehome': SessionsApi['rehome']
  'session.fork': SessionsApi['fork']
  'session.rewrite': SessionsApi['rewrite']
  ...
  'workspace.hide': WorkspaceApi['hide']
  'workspace.show': WorkspaceApi['show']
  ...
  'automation.list': AutomationApi['list']
  'automation.create': AutomationApi['create']
  'automation.update': AutomationApi['update']
  'automation.delete': AutomationApi['delete']
