 ...
 * plugin-owned entries (`agent-loop`, `bash`, `client-hmr`, `web-search-deepseek`)
 * are the host-plane sections the plugin configuration page and General
 * settings row edit; a namespace absent
...
const WEB_SETTINGS_NAMESPACES = [
  'agent-loop', 'client-hmr', 'shell', 'locale', 'permission', 'ui-conversation', 'ui-theme', 'web-search-deepseek',
] as const
