...
export function resolveRouteModels(
  ...
  const resolveEntry = (entry: PiAiModelProfile): DshModel => {
  ...
  return { models: serviceableModels, configuredMaxTokens, configuredSystemPrompts, configuredApiKeys, modelErrors }
}
