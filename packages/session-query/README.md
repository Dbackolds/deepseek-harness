...
| [`tool-session-control/`](tool-session-control/README.md) | Exposes session-control search, stop, send, rename, and library tools to the model | registers on `ctx.tools` |
