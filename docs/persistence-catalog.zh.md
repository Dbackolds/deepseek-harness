...
<a id="automationstart--log-only"></a>

#### `automation/start` — 仅日志
...
类型：[AutomationStartEvent](subsystems/automation.md)

来源：[`packages/automation/automation/src/types.ts:149`](../packages/automation/automation/src/types.ts)
