...
| [automation.md](automation.md) | Host-owned rules that open a fresh Session on a timer, overlap policy, and fire records |
...
| [session-control.md](session-control.md) | trusted directory over every logical session: live status, stop, and delivery |
