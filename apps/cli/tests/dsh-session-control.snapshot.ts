...
describe('dsh session-control assembled snapshot', () => {
  it('advertises and loads the bundled session-control skill through the shipped app', async () => {
    ...
    expect(snapshot).toMatchInlineSnapshot(`
      ...
      <available_skills>
      - \`dsh-session-control\`: Search every session, read whether it is running, stop a turn, send a later message, or archive, unarchive, and regroup conversations. Use when the user asks about other sessions, wants the conversation library managed, or names a session to interrupt or continue.
      </available_skills>
      ...
      Use the \`session_control_*\` tools to find any logical session, read whether it is running, stop its current turn, deliver a later message, or manage the conversation library (archive, unarchive, regroup).
      ...
      - Load this skill before searching, stopping, messaging, archiving, or regrouping another session.
      ...
      ",
        ...
        "summary": {
          "description": "Search every session, read whether it is running, stop a turn, send a later message, or archive, unarchive, and regroup conversations. Use when the user asks about other sessions, wants the conversation library managed, or names a session to interrupt or continue.",
          "invocation": {
            "modelInvocable": true,
            "userInvocable": true,
          },
